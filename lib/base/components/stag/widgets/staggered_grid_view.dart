...
/// ### Sample code
///
/// Here are two brief snippets showing a [CStaggeredGridView] and its equivalent using
/// [CustomScrollView]:
///
/// ```dart
...
class CStaggeredGridView extends BoxScrollView {
  ...
  const CStaggeredGridView.custom({
    Key? key,
    Axis scrollDirection = Axis.vertical,
    bool reverse = false,
    ScrollController? controller,
  ...
  CStaggeredGridView.count({
    ...
    bool addRepaintBoundaries = true,
    List<Widget> children = const <Widget>[],
    List<CStaggeredTile> staggeredTiles = const <CStaggeredTile>[],
    String? restorationId,
  ...
  /// [SliverVariableSizeChildListDelegate.addRepaintBoundaries] property. Both must not be
  /// null.
  CStaggeredGridView.countBuilder({
    Key? key,
    Axis scrollDirection = Axis.vertical,
    bool reverse = false,
    ScrollController? controller,
  ...
  ///
  ///  * [SliverGrid.extent], the equivalent constructor for [SliverGrid].
  CStaggeredGridView.extentBuilder({
    Key? key,
    Axis scrollDirection = Axis.vertical,
    bool reverse = false,
    ScrollController? controller,
  ...
  /// [CStaggeredGridView].
  ///
  /// The [CStaggeredGridView] and [StaggeredGridView.custom] constructors let you specify this
  /// delegate explicitly. The other constructors create a [gridDelegate]
  /// implicitly.
  final SliverStaggeredGridDelegate gridDelegate;

  /// A delegate that provides the children for the [CStaggeredGridView].
  ///
